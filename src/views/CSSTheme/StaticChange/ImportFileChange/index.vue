...
.top {
  background: linear-gradient(90deg, var(--shine) 0 0.75vmin, #fff0 0 100%),
  ...
  background-size: 1vmin 1.1vmin, 1vmin 1.1vmin, 1vmin 1.15vmin,
    0.45vmin 1.15vmin, 100% 100%, 100% 100%, 100% 100%, 100% 100%, 100% 100%,
    100% 100%;
...
.sea span {
  ...
  filter: drop-shadow(-14vmin 0vmin 0 #fff) drop-shadow(14vmin 0.85vmin 0 #fff)
    drop-shadow(-24vmin 1.85vmin 0 #fff) drop-shadow(-1vmin 3.5vmin 0 #fff)
    drop-shadow(6vmin 7vmin 0 #fff) drop-shadow(-6vmin 14vmin 0 #fff)
    drop-shadow(3vmin 28vmin 0 #fff) drop-shadow(3vmin 56vmin 0 #fff) blur(1px);
}
...
.sea span:before {
  ...
  box-shadow: 20.5vmin 0 0 var(--reflex), 24vmin 0 0 var(--reflex),
    ...
    89.5vmin 0 0 var(--reflex), 93vmin 0 0 var(--reflex),
...
.sky span:nth-child(6) {
  transform: translateX(27vmin) translateY(-38vmin) scale(3.75) scaleY(0.5)
    rotateY(180deg);
  opacity: 0.1;
}

.sky span:nth-child(7) {
  transform: translateX(-45vmin) translateY(-32vmin) scale(2.5) rotateY(180deg)
    scaleY(0.5);
}
